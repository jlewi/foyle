...
// @generated from file foyle/logs/traces.proto (syntax proto3)
/* eslint-disable */
// @ts-nocheck
...
export class Trace extends Message<Trace> {
  ...
  /**
   * @generated from oneof Trace.data
   */
  data: {
    /**
     * @generated from field: GenerateTrace generate = 4;
     */
    value: GenerateTrace;
    case: "generate";
  } | {
    /**
     * @generated from field: ExecuteTrace execute = 5;
     */
    value: ExecuteTrace;
    case: "execute";
  ...
  static readonly typeName = "Trace";
...
/**
 * @generated from message GenerateTrace
 */
export class GenerateTrace extends Message<GenerateTrace> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "GenerateTrace";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message ExecuteTrace
 */
export class ExecuteTrace extends Message<ExecuteTrace> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ExecuteTrace";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
