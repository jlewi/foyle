...
var file_foyle_logs_traces_proto_goTypes = []any{
...
func file_foyle_logs_traces_proto_init() {
	...
	file_foyle_logs_traces_proto_msgTypes[0].OneofWrappers = []any{
		(*Trace_Generate)(nil),
	}
	file_foyle_logs_traces_proto_msgTypes[1].OneofWrappers = []any{
		(*Span_Rag)(nil),
		(*Span_Llm)(nil),
	}
	type x struct{}
