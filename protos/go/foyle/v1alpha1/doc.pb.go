...
type BlockOutput struct {
	...
	Items []*BlockOutputItem `protobuf:"bytes,2,rep,name=items,proto3" json:"items,omitempty"`
}
...
func (x *BlockOutput) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
var file_foyle_v1alpha1_doc_proto_rawDesc = []byte{
	...
	0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x22, 0x45, 0x0a, 0x0b, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x4f,
	0x75, 0x74, 0x70, 0x75, 0x74, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x02, 0x69, 0x64, 0x12, 0x26, 0x0a, 0x05, 0x69, 0x74, 0x65, 0x6d, 0x73, 0x18, 0x02,
