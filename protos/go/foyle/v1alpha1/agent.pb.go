...
const (
	LogEvent_UNKNOWN LogEvent_ExecuteStatus = 0
	LogEvent_SUCCESS LogEvent_ExecuteStatus = 1
	LogEvent_FAILED  LogEvent_ExecuteStatus = 2
)

// Enum value maps for LogEvent_ExecuteStatus.
var (
	LogEvent_ExecuteStatus_name = map[int32]string{
		0: "UNKNOWN",
		1: "SUCCESS",
		2: "FAILED",
	}
	LogEvent_ExecuteStatus_value = map[string]int32{
		"UNKNOWN": 0,
		"SUCCESS": 1,
		"FAILED":  2,
	}
...
func (x LogEvent_ExecuteStatus) Enum() *LogEvent_ExecuteStatus {
	p := new(LogEvent_ExecuteStatus)
	*p = x
	return p
}

func (x LogEvent_ExecuteStatus) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}
...
// Deprecated: Use LogEvent_ExecuteStatus.Descriptor instead.
func (LogEvent_ExecuteStatus) EnumDescriptor() ([]byte, []int) {
	return file_foyle_v1alpha1_agent_proto_rawDescGZIP(), []int{16, 0}
}
...
type LogEvent struct {
	...
	ExecuteStatus LogEvent_ExecuteStatus `protobuf:"varint,7,opt,name=execute_status,json=executeStatus,proto3,enum=LogEvent_ExecuteStatus" json:"execute_status,omitempty"`
}
...
func (x *LogEvent) GetExecuteStatus() LogEvent_ExecuteStatus {
	if x != nil {
		return x.ExecuteStatus
	}
	return LogEvent_UNKNOWN
}
...
var file_foyle_v1alpha1_agent_proto_rawDesc = []byte{
	...
	0x65, 0x6e, 0x74, 0x52, 0x06, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x73, 0x22, 0xd3, 0x02, 0x0a, 0x08,
	...
	0x63, 0x75, 0x74, 0x65, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x22, 0x35, 0x0a, 0x0d, 0x45, 0x78,
	...
	0x02, 0x22, 0x13, 0x0a, 0x11, 0x4c, 0x6f, 0x67, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x73, 0x52, 0x65,
