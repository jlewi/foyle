...
var file_foyle_v1alpha1_agent_proto_rawDesc = []byte{
	...
	0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x2a, 0x32, 0x0a, 0x0f, 0x41, 0x49, 0x53, 0x65, 0x72,
	...
	0x0a, 0x0a, 0x06, 0x4e, 0x4f, 0x54, 0x5f, 0x4f, 0x4b, 0x10, 0x02, 0x32, 0x65, 0x0a, 0x0f, 0x47,
	0x65, 0x6e, 0x65, 0x72, 0x61, 0x74, 0x65, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x52,
	0x0a, 0x08, 0x47, 0x65, 0x6e, 0x65, 0x72, 0x61, 0x74, 0x65, 0x12, 0x10, 0x2e, 0x47, 0x65, 0x6e,
	0x65, 0x72, 0x61, 0x74, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x11, 0x2e, 0x47,
	...
	0x74, 0x65, 0x32, 0x60, 0x0a, 0x0e, 0x45, 0x78, 0x65, 0x63, 0x75, 0x74, 0x65, 0x53, 0x65, 0x72,
	0x76, 0x69, 0x63, 0x65, 0x12, 0x4e, 0x0a, 0x07, 0x45, 0x78, 0x65, 0x63, 0x75, 0x74, 0x65, 0x12,
	...
	0x61, 0x70, 0x69, 0x2f, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x31, 0x2f, 0x65, 0x78, 0x65,
	0x63, 0x75, 0x74, 0x65, 0x32, 0xc3, 0x01, 0x0a, 0x09, 0x41, 0x49, 0x53, 0x65, 0x72, 0x76, 0x69,
	...
	0x6c, 0x6c, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x2b, 0x0a,
	...
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x3f, 0x42, 0x0a, 0x41, 0x67,
...
var file_foyle_v1alpha1_agent_proto_msgTypes = make([]protoimpl.MessageInfo, 13)
var file_foyle_v1alpha1_agent_proto_goTypes = []interface{}{
	...
	(*Doc)(nil),                    // 14: Doc
	(*Block)(nil),                  // 15: Block
	(*BlockOutput)(nil),            // 16: BlockOutput
	(*v1.Notebook)(nil),            // 17: runme.parser.v1.Notebook
	(*v1.Cell)(nil),                // 18: runme.parser.v1.Cell
}
var file_foyle_v1alpha1_agent_proto_depIdxs = []int32{
	14, // 0: GenerateRequest.doc:type_name -> Doc
	15, // 1: GenerateResponse.blocks:type_name -> Block
	15, // 2: ExecuteRequest.block:type_name -> Block
	16, // 3: ExecuteResponse.outputs:type_name -> BlockOutput
	6,  // 4: StreamGenerateRequest.full_context:type_name -> FullContext
	7,  // 5: StreamGenerateRequest.update:type_name -> UpdateContext
	17, // 6: FullContext.notebook:type_name -> runme.parser.v1.Notebook
	18, // 7: UpdateContext.cell:type_name -> runme.parser.v1.Cell
	18, // 8: StreamGenerateResponse.cells:type_name -> runme.parser.v1.Cell
	17, // 9: GenerateCellsRequest.notebook:type_name -> runme.parser.v1.Notebook
	18, // 10: GenerateCellsResponse.cells:type_name -> runme.parser.v1.Cell
	0,  // 11: StatusResponse.status:type_name -> AIServiceStatus
	1,  // 12: GenerateService.Generate:input_type -> GenerateRequest
	3,  // 13: ExecuteService.Execute:input_type -> ExecuteRequest
	5,  // 14: AIService.StreamGenerate:input_type -> StreamGenerateRequest
	10, // 15: AIService.GenerateCells:input_type -> GenerateCellsRequest
	12, // 16: AIService.Status:input_type -> StatusRequest
	2,  // 17: GenerateService.Generate:output_type -> GenerateResponse
	4,  // 18: ExecuteService.Execute:output_type -> ExecuteResponse
	9,  // 19: AIService.StreamGenerate:output_type -> StreamGenerateResponse
	11, // 20: AIService.GenerateCells:output_type -> GenerateCellsResponse
	13, // 21: AIService.Status:output_type -> StatusResponse
