...
var file_foyle_v1alpha1_agent_proto_rawDesc = []byte{
	...
	0x73, 0x65, 0x72, 0x74, 0x41, 0x74, 0x32, 0x65, 0x0a, 0x0f, 0x47, 0x65, 0x6e, 0x65, 0x72, 0x61,
	...
	0x91, 0x01, 0x0a, 0x09, 0x41, 0x49, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x47, 0x0a,
	...
	0x22, 0x00, 0x28, 0x01, 0x30, 0x01, 0x12, 0x3b, 0x0a, 0x06, 0x53, 0x69, 0x6d, 0x70, 0x6c, 0x65,
...
var file_foyle_v1alpha1_agent_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var file_foyle_v1alpha1_agent_proto_goTypes = []interface{}{
	...
	(*StreamGenerateRequest)(nil),  // 4: StreamGenerateRequest
	(*FullContext)(nil),            // 5: FullContext
	(*UpdateContext)(nil),          // 6: UpdateContext
	(*Finish)(nil),                 // 7: Finish
	(*StreamGenerateResponse)(nil), // 8: StreamGenerateResponse
	(*Doc)(nil),                    // 9: Doc
	(*Block)(nil),                  // 10: Block
	(*BlockOutput)(nil),            // 11: BlockOutput
	(*v1.Notebook)(nil),            // 12: runme.parser.v1.Notebook
	(*v1.Cell)(nil),                // 13: runme.parser.v1.Cell
}
var file_foyle_v1alpha1_agent_proto_depIdxs = []int32{
	9,  // 0: GenerateRequest.doc:type_name -> Doc
	10, // 1: GenerateResponse.blocks:type_name -> Block
	10, // 2: ExecuteRequest.block:type_name -> Block
	11, // 3: ExecuteResponse.outputs:type_name -> BlockOutput
	5,  // 4: StreamGenerateRequest.full_context:type_name -> FullContext
	6,  // 5: StreamGenerateRequest.update:type_name -> UpdateContext
	12, // 6: FullContext.notebook:type_name -> runme.parser.v1.Notebook
	13, // 7: UpdateContext.cell:type_name -> runme.parser.v1.Cell
	13, // 8: StreamGenerateResponse.cells:type_name -> runme.parser.v1.Cell
	0,  // 9: GenerateService.Generate:input_type -> GenerateRequest
	2,  // 10: ExecuteService.Execute:input_type -> ExecuteRequest
	4,  // 11: AIService.StreamGenerate:input_type -> StreamGenerateRequest
	4,  // 12: AIService.Simple:input_type -> StreamGenerateRequest
	1,  // 13: GenerateService.Generate:output_type -> GenerateResponse
	3,  // 14: ExecuteService.Execute:output_type -> ExecuteResponse
	8,  // 15: AIService.StreamGenerate:output_type -> StreamGenerateResponse
	8,  // 16: AIService.Simple:output_type -> StreamGenerateResponse
